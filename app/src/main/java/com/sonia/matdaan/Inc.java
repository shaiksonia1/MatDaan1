                ...
                mUserRef.child("voted").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.getValue().toString().equals("no")){
                            mVoteRef.child("INC").push().setValue(ServerValue.TIMESTAMP).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                            ...
                            Toast.makeText(Inc.this, "You have already voted.", Toast.LENGTH_SHORT).show();
                        }
                    }
